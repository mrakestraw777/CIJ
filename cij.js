...
function transcriptVocab(){
  let vocabInTranscripts = [];
  fullTranscripts.forEach(e=>{
    let newTranscriptSearchResults = {};
    newTranscriptSearchResults.title = e.title;
    newTranscriptSearchResults.url = e.url;
    newTranscriptSearchResults.level = e.level;

    core2000.forEach(d=>{
      newTranscriptSearchResults.kanji = d.kanji;
      newTranscriptSearchResults.kana = d.kana;
      let kanjiCount = stringSearch(e.transcript,d.kanji);
      let kanaCount = stringSearch(e.transcript_furigana,d.kana)
      
    }) /* core2000 forEach */
  })/* fullTranscripts forEach */
}; //transcriptVocab FUNCTION END!!!
...
function presentArrayData(formattedArray)
{
  ...
  Check <a target="blank" href="https://jisho.org/search/${formattedArray[0].term}">Jisho.org</a> for more forms you might search.</p>
  <p>Need some help remembering the Kanji? Try <a target="blank" href="https://www.wanikani.com/search?utf8=%E2%9C%93&query=${formattedArray[0].term}&button=">Wanikani</a></p>
  <br>
  `;
...
let fullTranscripts = [
  ...
  {
      title: `肉じゃがの作り方 How to cook Nikujaga (Japanese Food)`,
      url: `https://cijapanese.com/how-to-cook-nikujaga-japanese-food/`,
      level: `beginner`,
      membership: `free`,
      transcript: `今私はどこにいますか。ここはどこでしょう。ここはキッチンです。今私は台所にいます。今から料理をします。

      肉じゃがという日本の料理を知っていますか。これが肉じゃがです。日本の料理、和食です。今から肉じゃがを作ります。
      
      とっても簡単ですよ。難しくありません。簡単なレシピです。私は料理があんまり得意ではありません。料理が上手ではありません。でも私でも作れる簡単なレシピです。
      
      まず材料を紹介します。これは牛肉です。牛肉です。牛の肉です。今日は牛肉を使います。でも豚肉でもいいです。今日は牛肉を使います。これは玉ねぎです。これは人参です。これはじゃがいもです。このじゃがいもは私の父が作ったじゃがいもです。玉ねぎ１個、人参１本、じゃがいも３個、牛肉２００gを使います。
      
      あと水２００ml、調味料はみりんを大さじ２。小さじではなくて大さじ２杯、醤油も大さじ２、酒大さじ２、砂糖大さじ２。あと、これは和風だしです。和風の、日本風のスープの素です。これを大さじ２分の１使います。材料は以上です。この材料を使って肉じゃがを作ります。
      
      まずじゃがいもの皮を剥きます。皮むき器でじゃがいもの皮を剥きます。人参も皮を剥きます。玉ねぎも皮を剥きます。野菜の皮が全部剥けました。
      
      今度は野菜を切ります。これはまな板です。これは包丁です。包丁で野菜を切ります。人参は乱切りにします。みじん切りではありません。千切りでもありません。乱切りにします。野菜を全部切りました。今度は牛肉を切ります。
      
      調味料を合わせておきます。和風だし大さじ２分の１、醤油大さじ２、酒大さじ２、みりん大さじ２。調味料を合わせて混ぜておきます。
      
      これは鍋です。鍋に油を入れます。火を点けます。まず肉を炒めます。肉の色が変わったら野菜を入れます。野菜と肉を一緒に炒めます。砂糖と水を入れます。合わせた調味料も入れます。落し蓋をしてグツグツ煮込みます。
      
      落し蓋はこんな蓋です。でも私は落し蓋を持っていません。うちには落し蓋がありません。なので代わりにアルミホイルを使います。丸くして穴を開けます。そして上に乗せます。これでしばらく煮込みます。
      
      今４時８分です。４時半くらいまで、２０分ちょっと煮込みます。今まだ人参とかじゃがいもが硬いです。硬いです。人参やじゃがいもが柔らかくなるまで煮込みます。
      
      ４時半になりました。柔らかくなっているか見てみましょう。じゃがいもも人参も柔らかくなっています。
      
      今この肉じゃがは熱いですね。まだ熱いです。肉じゃがは冷めるときにじゃがいもや人参に味が染み込んで美味しくなるんだそうです。なので１回冷ましてもう１回温めてから食べます。
      
      肉じゃが完成！`,
      transcript_furigana: `今いま　私わたしは　どこに　いますか。

      ここは　どこでしょう。
      
      ここは　キッチンきっちんです。
      
      今いま　私わたしは　台所だいどころに　います。
      
      今いまから　料理りょうりを　します。
      
      肉にくじゃがという　日本にほんの　料理りょうりを　知っていますか。
      
      これが　肉にくじゃがです。
      
      日本にほんの　料理りょうり、　和食わしょくです。
      
      今いまから　肉にくじゃがを　作つくります。
      ...
      私わたしは　料理りょうりが　あんまり　得意とくいではありません。
      
      料理りょうりが　上手じょうずではありません。
      
      でも　私わたしでも　作つくれる　簡単かんたんな　レシピれしぴです。
      
      まず　材料ざいりょうを　紹介しょうかいします。
      ...
      この　じゃがいもは　私わたしの　父ちちが　作つくった　じゃがいもです。
      
      玉たまねぎ　１個いっこ、　人参にんじん　１本いっぽん、　じゃがいも　３個さんこ、　牛肉ぎゅうにく　２００gにひゃくぐらむを　使つかいます。
      
      あと　水みず　２００にひゃくmlみりりっとる、　調味料ちょうみりょうは　みりんを　大おおさじ２に。
      
      小こさじではなくて　大おおさじ　２杯にはい、　醤油しょうゆも　大おおさじ２に、　酒さけ　大おおさじ２に、　砂糖さとう　大おおさじ２に。
      
      あと　これは　和風わふうだしです。
      
      和風わふうの、　日本にほん風ふうの　スープすーぷの　素もとです。
      
      これを　大おおさじ　２分にぶんの１いち　使つかいます。
      
      材料ざいりょうは　以上いじょうです。
      
      この　材料ざいりょうを　使つかって　肉にくじゃがを　作つくります。
      
      まず　じゃがいもの　皮かわを　剥むきます。
      
      皮かわむき器きで　じゃがいもの　皮かわを　剥むきます。
      
      人参にんじんも　皮かわを　剥むきます。
      
      玉たまねぎも　皮かわを　剥むきます。
      
      野菜やさいの　皮かわが　全部ぜんぶ　剥むけました。
      ...
      今度こんどは　牛肉ぎゅうにくを　切きります。
      
      調味料ちょうみりょうを　合あわせておきます。
      
      和風わふうだし　大おおさじ　２分にぶんの１いち、　醤油しょうゆ　大おおさじ２に、　酒さけ　大おおさじ２に、　みりん　大おおさじ２に。
      
      調味料ちょうみりょうを　合あわせて　混まぜておきます。
      ...
      肉にくの　色いろが　変かわったら　野菜やさいを　入いれます。
      
      野菜やさいと　肉にくを　一緒いっしょに　炒いためます。
      
      砂糖さとうと　水みずを　入いれます。
      
      合あわせた　調味料ちょうみりょうも　入いれます。
      
      落おとし蓋ぶたを　して　グツグツ　煮込にこみます。
      
      落おとし蓋ぶたは　こんな　蓋ふたです。
      
      でも　私わたしは　落おとし蓋ぶたを　持もっていません。
      
      うちには　落おとし蓋ぶたが　ありません。
      
      なので　代かわりに　アルミホイルあるみほいるを　使つかいます。
      ...
      ４時半よじはんくらいまで　２０分にじっぷんちょっと　煮込にこみます。
      
      今　まだ　人参にんじんとか　じゃがいもが　硬かたいです。
      
      硬かたいです。
      
      人参にんじんや　じゃがいもが　柔やわらかく　なるまで　煮込にこみます。
      
      ４時半よじはんに　なりました。
      
      柔やわらかく　なっているか　見みてみましょう。
      
      じゃがいもも　人参にんじんも　柔やわらかくなっています。
      
      今いま　この　肉にくじゃがは　熱あついですね。
      
      まだ　熱あついです。
      
      肉にくじゃがは　冷さめるときに　じゃがいもや　人参にんじんに　味あじが　染しみ込こんで　美味おいしくなるんだそうです。
      
      なので　１回いっかい　冷さまして　もう１回いっかい　温あたためてから　食たべます。
  ...
  },
  {
      ...
      この写真を見てください。何人いますか。１人、２人、３人、４人。４人います。男の人は何人ですか。男の人は１人です。男の人はこの人だけです。女の人は何人ですか。女の人は３人です。
      
      この写真を見てください。何人いますか。数えてみましょう。１人、２人、３人、４人、５人、６人、７人、８人、９人、１０人、１１人…数え切れません。たくさんいます。人がたくさんいます。
      
      この写真を見てください。何人いますか。３人います。大人は何人いますか。大人は２人います。子供は何人ですか。子供は１人です。男の人が１人、女の人が１人、男の子が１人います。女の子はいません。
      
      この写真はどうですか。大人は何人いますか。１人、２人、３人、４人。大人は４人います。子供は何人ですか。子供は１人です。子供はこの子だけです。男性は何人ですか。男性は２人です。男の人は２人います。女性は何人いますか。女性は２人です。女の人は２人です。男の子はいますか。男の子はいません。女の子が１人います。
      
      子供がたくさんいますね。何人いますか。１人、２人、３人、４人、５人、６人、７人、８人、９人。子供が９人います。男の子は何人ですか。１人、２人、３人。男の子は３人です。女の子は何人ですか。１人、２人、３人、４人、５人、６人。女の子は６人です。男の子が３人と女の子が６人。合わせて子供が９人います。全部で９人います。大人はいますか。大人はいません。子供だけです。子供しかいません。
      
      男の子はいますか。男の子はいません。女の子２人と犬がいます。犬は何匹いますか。犬は１匹です。１匹犬がいます。
      
      犬と猫がいます。犬は何匹いますか。１匹、２匹。犬は２匹です。猫は何匹いますか。１匹、２匹。猫も２匹です。犬と猫が２匹ずついます。合わせて４匹います。
      
      犬がいます。茶色い犬がいます。可愛いですね。何匹いますか。３匹います。茶色い犬が３匹います。
      
      猫がいます。可愛いですね。何匹いますか。１匹、２匹、３匹、４匹、あと、ここにもいます。ここにももう１匹います。全部で５匹います。この猫は寝ていますね。
      
      この写真には何人いますか。４人います。大人は何人ですか。大人は２人です。子供は何人ですか。子供も２人です。大人と子供が２人ずついます。男性と女性と男の子と女の子が１人ずついます。猫はいますか。猫はいません。犬はいますか。犬はいます。ここに１匹犬がいます。
      
      魚は何匹いますか。数えてみましょう。１匹、２匹、３匹、４匹、５匹、６匹、７匹、８匹、９匹、１０匹、１１匹、１２匹…数え切れません。たくさんいます。魚がたくさんいます。
      
      小さい犬が３匹います。小さい猫が５匹います。
      
      これは象です。象は小さいですか。それとも大きいですか。象も大きいですね。象が何頭いますか。１頭、２頭、３頭、４頭、５頭、６頭、７頭。象が７頭います。大人の象は何頭いますか。大人の象は５頭います。子供の象は何頭いますか。子供の象は２頭です。
      
      この写真を見てください。ライオンがいます。これはライオンです。ライオンも大きいですね。ライオンは何頭いますか。１頭、２頭、３頭。３頭います。
      
      これは鳥です。鳥が飛んでいます。鳥は何羽いますか。１羽、２羽、３羽、４羽、５羽。５羽います。５羽の鳥が飛んでいます。
      
      この写真には鳥は何羽いますか。たくさんいます。たくさんの鳥が飛んでいます。
      
      写真は全部で何枚ありましたか。１枚、２枚、３枚、４枚、５枚、６枚、７枚、８枚、９枚、１０枚、１１枚、１２枚、１３枚、１４枚、１５枚、１６枚。全部で１６枚ありました。
      
      今日はこれでおしまい。またね！`,
      transcript_furigana: `この写真しゃしんを見みてください。

      人ひとがいます。人ひとがいます。
      
      何人なんにんいますか。何人なんにんいますか。
      
      １人ひとり、２人ふたり、３人さんにん。３人さんにんいます。
      
      この人ひとは男おとこの人ひとです。男性だんせいです。
      
      この人達ひとたちは女おんなの人ひとです。女性じょせいです。
      
      男おとこの人ひとは何人なんにんいますか。１人ひとりいます。
      
      女おんなの人ひとは何人なんにんいますか。１人ひとり、２人ふたり。２人ふたりいます。
      
      男性だんせいが１人ひとり、女性じょせいが２人ふたりいます。
      
      この写真しゃしんを見みてください。何人なんにんいますか。
      
      １人ひとり、２人ふたり、３人さんにん、４人よにん。４人よにんいます。
      
      男おとこの人ひとは何人なんにんですか。男おとこの人ひとは１人ひとりです。
      
      男おとこの人ひとはこの人ひとだけです。
      
      女おんなの人ひとは何人なんにんですか。女おんなの人ひとは３人です。
      
      この写真しゃしんを見みてください。何人なんにんいますか。
      
      数かぞえてみましょう。
      
      １人ひとり、２人ふたり、３人さんにん、４人よにん、５人ごにん、６人ろくにん、７人しちにん、８人はちにん、９人きゅうにん、１０人じゅうにん、１１人じゅういちにん…
      ...
      何人なんにんいますか。３人さんにんいます。
      
      大人おとなは何人なんにんいますか。大人おとなは２人ふたりいます。
      
      子供こどもは何人なんにんですか。子供こどもは１人ひとりです。
      
      男おとこの人ひとが１人ひとり、女おんなの人ひとが１人ひとり、男おとこの子こが１人ひとりいます。
      ...
      １人ひとり、２人ふたり、３人さんにん、４人よにん。大人おとなは４人よにんいます。
      
      子供こどもは何人なんにんですか。子供こどもは１人ひとりです。子供こどもはこの子こだけです。
      
      男性だんせいは何人なんにんですか。男性だんせいは２人ふたりです。男おとこの人ひとは２人ふたりいます。
      
      女性じょせいは何人なんにんいますか。女性じょせいは２人ふたりです。女おんなの人ひとは２人ふたりです。
      
      男おとこの子こはいますか。男おとこの子こはいません。
      ...
      １人ひとり、２人ふたり、３人さんにん、４人よにん、５人ごにん、６人ろくにん、７人しちにん、８人はちにん、９人きゅうにん。
      
      子供こどもが９人きゅうにんいます。
      
      男おとこの子こは何人なんにんですか。１人ひとり、２人ふたり、３人さんにん。男おとこの子こは３人さんにんです。
      
      女おんなの子こは何人なんにんですか。１人ひとり、２人ふたり、３人さんにん、４人よにん、５人ごにん、６人ろくにん。女おんなの子こは６人です。
      
      男おとこの子こが３人さんにんと女おんなの子こが６人ろくにん。合あわせて子供こどもが９人きゅうにんいます。
      
      全部ぜんぶで９人きゅうにんいます。
      
      大人おとなはいますか。大人おとなはいません。
      
      子供こどもだけです。子供こどもしかいません。
      
      男おとこの子こはいますか。男おとこの子こはいません。
      
      女おんなの子こ２人ふたりと犬いぬがいます。
      
      犬いぬは何匹なんびきいますか。犬いぬは１匹いっぴきです。１匹いっぴき犬いぬがいます。
      
      犬いぬと猫ねこがいます。
      
      犬いぬは何匹なんびきいますか。１匹いっぴき、２匹にひき。犬いぬは２匹にひきです。
      
      猫ねこは何匹なんびきいますか。１匹いっぴき、２匹にひき。猫ねこも２匹にひきです。
      
      犬いぬと猫ねこが２匹にひきずついます。
      
      合あわせて４匹よんひきいます。
      
      犬いぬがいます。茶色ちゃいろい犬いぬがいます。
      
      可愛かわいいですね。
      
      何匹なんびきいますか。３匹さんびきいます。
      
      茶色ちゃいろい犬いぬが３匹さんびきいます。
      
      猫ねこがいます。可愛かわいいですね。
      
      何匹なんびきいますか。１匹いっぴき、２匹にひき、３匹さんびき、４匹よんひき、あと、ここにもいます。
      ...
      この写真しゃしんには何人なんにんいますか。４人よにんいます。
      
      大人おとなは何人なんにんですか。大人おとなは２人ふたりです。
      
      子供こどもは何人なんにんですか。子供こどもも２人ふたりです。
      
      大人おとなと子供こどもが２人ふたりずついます。
      
      男性だんせいと女性じょせいと男おとこの子こと女おんなの子こが１人ひとりずついます。
      
      猫ねこはいますか。猫ねこはいません。
      
      犬いぬはいますか。犬いぬはいます。ここに１匹いっぴき犬いぬがいます。
      
      魚さかなは何匹なんびきいますか。数かぞえてみましょう。
      
      １匹いっぴき、２匹にひき、３匹さんびき、４匹よんひき、５匹ごひき、６匹ろっぴき、７匹ななひき、８匹はちひき、９匹きゅうひき、１０匹じゅっぴき、１１匹じゅういっぴき、１２匹じゅうにひき…
      
      数かぞえ切きれません。
      
      たくさんいます。魚さかながたくさんいます。
      ...
      象ぞうは小ちいさいですか。それとも大おおきいですか。
      
      象ぞうは大おおきいですね。
      
      象ぞうが何頭なんとういますか。１頭いっとう、２頭にとう、３頭さんとう、４頭よんとう、５頭ごとう、６頭ろくとう、７頭ななとう。象ぞうが７頭ななとういます。
      
      大人おとなの象ぞうは何頭なんとういますか。大人おとなの象ぞうは５頭ごとういます。
      
      子供こどもの象ぞうは何頭なんとういますか。子供こどもの象ぞうは２頭にとうです。
      
      この写真しゃしんを見みてください。
      
      ライオンらいおんがいます。これはライオンらいおんです。
      
      ライオンらいおんも大おおきいですね。
      
      ライオンらいおんは何頭なんとういますか。１頭いっとう、２頭にとう、３頭さんとう。３頭さんとういます。
      
      これは鳥とりです。鳥とりが飛とんでいます。
      
      鳥とりは何羽なんわいますか。１羽いちわ、２羽にわ、３羽さんわ、４羽よんわ、５羽ごわ。５羽ごわいます。
      
      ５羽ごわの鳥とりが飛とんでいます。
      
      この写真しゃしんには鳥とりは何羽なんわいますか。たくさんいます。
      
      たくさんの鳥とりが飛とんでいます。
      
      写真しゃしんは全部ぜんぶで何枚なんまいありましたか。
      
      １枚いちまい、２枚にまい、３枚さんまい、４枚よんまい、５枚ごまい、６枚ろくまい、７枚ななまい、８枚はちまい、９枚きゅうまい、１０枚じゅうまい、１１枚じゅういちまい、１２枚じゅうにまい、１３枚じゅうさんまい、１４枚じゅうよんまい、１５枚じゅうごまい、１６枚じゅうろくまい。
      
      全部ぜんぶで１６枚じゅうろくまいありました。
      
      今日きょうはこれでおしまい。またね！`
  },
  {
      title: `歌舞伎 Kabuki`,
      url: `https://cijapanese.com/kabuki/`,
      level: `intermediate`,
      membership: `free`,
      transcript: `今日のテーマは「歌舞伎」です。江戸時代から続く日本の伝統芸能「歌舞伎」について話します。皆さん歌舞伎、ご存知ですか。これが歌舞伎です。昔から続く伝統的な日本の芝居です。歌舞伎は音楽と踊りと芝居が合わさった舞台です。

      これは歌舞伎役者です。歌舞伎の俳優です。こんな風に顔を白く塗って、派手な化粧をして、派手なメイクをして、着物を着て歌ったり踊ったり芝居をしたりします。歌舞伎の役者さん、歌舞伎に出る俳優さんは全員男性です。女性の役も男性が演じます。男性が女性の格好をして演じます。
      
      皆さん、実際に歌舞伎を観たことはありますか。実は私は観たことないんです。日本人なのに。実際に劇場に行って生で歌舞伎の舞台を観たことは一度もありません。
      
      ちょっとここで歌舞伎の歴史について話したいと思います。歌舞伎が始まったのは今から４００年以上も前の江戸時代のことです。１６０３年に出雲阿国という女性が歌舞伎踊りといわれる踊りを始めました。さっき歌舞伎の役者さんはみんな男性ですよ、と言ったんですけど、最初に始めたのは女性でした。
      
      ちなみに歌舞伎という名前の由来は「かぶく」という動詞だそうです。かぶくという言葉は普段あんまり聞かない言葉なんですけど、派手な格好をする、奇抜な格好をするという意味があるそうです。奇抜な格好をして踊っていたので歌舞伎踊りと言われるようになったそうです。
      
      出雲阿国の歌舞伎踊りが人気が出たので、その真似をして女の人達が踊る女歌舞伎というものが生まれました。でも江戸幕府がこの女性たちによる女歌舞伎を禁止しました。そしてその後に今度は若い少年たち、かっこいい美少年たちによる若衆歌舞伎というものが生まれました。でもこれも江戸幕府に禁止されました。
      
      その後に現在の歌舞伎と同じように、大人の男の人、成人男性による歌舞伎が始まって、それが今も続いています。歌舞伎は１６００年代の終わり頃から広く一般の人に楽しまれる様になったそうです。
      
      歌舞伎はもちろん今でも伝統的な日本の文化として大切にされていますし、今も人気ですけど、どちらかというと若い人たちよりも年配の人たちに人気があるというイメージです。若い人たちよりも年配の方たちが観るものというイメージがあります。
      
      私のイメージだとちょっと難しそうだなとか、あとは行きにくいというイメージがあります。なんとなく敷居が高くて気軽に行けない、簡単に行けないものというイメージがあります。でも最近は今風にアレンジした歌舞伎も色々と上演されてるみたいです。
      
      例えば２０１５年にはワンピースの歌舞伎が上演されたらしいです。それから２０１９年にはナウシカの歌舞伎もあったそうですよ。面白そうですよね。あと去年２０２０年にはNARUTOの歌舞伎も上演予定だったそうです。でもこれは残念ながらコロナの影響で中止になってしまったそうです。こういうのだと若い人たちでも面白そうって興味が湧いて、観てみたくなりそうですよね。
      
      私が住んでいる福岡にも実は博多座という名前の、こんな立派な劇場があります。ここで歌舞伎も観られるみたいです。せっかく近くにあるのでいつか行ってみたいなと思います。
      
      今日は日本の伝統芸能、歌舞伎について話しました。今日はこれでおしまい。またね！`,
      transcript_furigana: `今日きょうのテーマは「歌舞伎かぶき」です。

江戸えど時代じだいから続つづく日本にほんの伝統でんとう芸能げいのう「歌舞伎かぶき」について話はなします。

皆みなさん歌舞伎かぶき、ご存知ぞんじですか。これが歌舞伎かぶきです。

昔むかしから続つづく伝統的でんとうてきな日本にほんの芝居しばいです。

歌舞伎かぶきは音楽おんがくと踊おどりと芝居しばいが合あわさった舞台ぶたいです。

これは歌舞伎かぶき役者やくしゃです。歌舞伎かぶきの俳優はいゆうです。

こんな風ふうに顔かおを白しろく塗ぬって、派手はでな化粧けしょうをして、派手はでなメイクをして、着物きものを着きて歌うたったり踊おどったり芝居しばいをしたりします。

歌舞伎かぶきの役者やくしゃさん、歌舞伎かぶきに出でる俳優はいゆうさんは全員ぜんいん男性だんせいです。

女性じょせいの役やくも男性だんせいが演えんじます。男性だんせいが女性じょせいの格好かっこうをして演えんじます。

皆みなさん、実際じっさいに歌舞伎かぶきを観みたことはありますか。

実じつは私わたしは観みたことないんです。日本人にほんじんなのに。

実際じっさいに劇場げきじょうに行いって生なまで歌舞伎かぶきの舞台ぶたいを観みたことは一度いちどもありません。

ちょっとここで歌舞伎かぶきの歴史れきしについて話はなしたいと思おもいます。

歌舞伎かぶきが始はじまったのは今いまから４００年以上よんひゃくねんいじょうも前まえの江戸時代えどじだいのことです。

１６０３年せんろっぴゃくさんねんに出雲阿国いづものおくにという女性じょせいが歌舞伎かぶき踊おどりといわれる踊おどりを始はじめました。

さっき歌舞伎かぶきの役者やくしゃさんはみんな男性だんせいですよ、と言いったんですけど、最初さいしょに始はじめたのは女性じょせいでした。

ちなみに歌舞伎かぶきという名前なまえの由来ゆらいは「かぶく」という動詞どうしだそうです。

かぶくという言葉ことばは普段ふだんあんまり聞きかない言葉ことばなんですけど、派手はでな格好かっこうをする、奇抜きばつな格好かっこうをするという意味いみがあるそうです。

奇抜きばつな格好かっこうをして踊おどっていたので歌舞伎かぶき踊おどりと言いわれるようになったそうです。

出雲阿国いづものおくにの歌舞伎かぶき踊おどりが人気にんきが出でたので、その真似まねをして女おんなの人達ひとたちが踊おどる女おんな歌舞伎かぶきというものが生うまれました。

でも江戸幕府えどばくふがこの女性じょせいたちによる女おんな歌舞伎かぶきを禁止きんししました。

そしてその後あとに今度こんどは若わかい少年しょうねんたち、かっこいい美少年びしょうねんたちによる若衆わかしゅう歌舞伎かぶきというものが生うまれました。

でもこれも江戸幕府えどばくふに禁止きんしされました。

その後あとに現在げんざいの歌舞伎かぶきと同おなじように、大人おとなの男おとこの人ひと、成人せいじん男性だんせいによる歌舞伎かぶきが始はじまって、それが今いまも続つづいています。

歌舞伎かぶきは１６００年代せんろっぴゃくねんだいの終おわり頃ごろから広ひろく一般いっぱんの人ひとに楽たのしまれる様ようになったそうです。

歌舞伎かぶきはもちろん今いまでも伝統的でんとうてきな日本にほんの文化ぶんかとして大切たいせつにされていますし、今いまも人気にんきですけど、どちらかというと若わかい人ひとたちよりも年配ねんぱいの人ひとたちに人気にんきがあるというイメージです。

若わかい人ひとたちよりも年配ねんぱいの方かたたちが観みるものというイメージがあります。

私わたしのイメージだとちょっと難むずかしそうだなとか、あとは行いきにくいというイメージがあります。

なんとなく敷居しきいが高たかくて気軽きがるに行いけない、簡単かんたんに行いけないものというイメージがあります。

でも最近さいきんは今風いまふうにアレンジした歌舞伎かぶきも色々いろいろと上演じょうえんされてるみたいです。

例たとえば２０１５年にせんじゅうごねんにはワンピースの歌舞伎かぶきが上演じょうえんされたらしいです。

それから２０１９年にせんじゅうきゅうねんにはナウシカの歌舞伎かぶきもあったそうですよ。面白おもしろそうですよね。

あと去年きょねん２０２０年にせんにじゅうねんにはNARUTOの歌舞伎かぶきも上演予定じょうえんよていだったそうです。

でもこれは残念ざんねんながらコロナの影響えいきょうで中止ちゅうしになってしまったそうです。

こういうのだと若わかい人ひとたちでも面白おもしろそうって興味きょうみが湧わいて、観みてみたくなりそうですよね。

私わたしが住すんでいる福岡ふくおかにも実じつは博多座はかたざという名前なまえの、こんな立派りっぱな劇場げきじょうがあります。

ここで歌舞伎かぶきも観みられるみたいです。

せっかく近ちかくにあるのでいつか行いってみたいなと思おもいます。

今日きょうは日本にほんの伝統芸能でんとうげいのう、歌舞伎かぶきについて話しました。

今日きょうはこれでおしまい。またね！`
  },{
    title: `私の自己紹介 My Self Introduction`,
    url: `https://cijapanese.com/my-self-introduction/`,
    level: `complete beginner`,
    membership: `free`,
    transcript: `こんにちは。今日は私の自己紹介をします。私の自己紹介をします。

    私の名前はゆきです。３５歳です。日本人です。日本の福岡に住んでいます。日本語の先生です。日本語の動画を作っています。
    
    私の名前はゆきです。私の名前はドラえもんですか。違います。私の名前はドラえもんではありません。ドラえもんではなくてゆきです。私の名前はキティーですか。ゆきですか。私の名前はゆきです。私の名前は何ですか。ゆきです。私の名前はゆきです。
    
    私は３５歳です。私は２５歳ですか。いいえ、２５歳ではありません。２５歳ではなくて３５歳です。私は４５歳ですか。３５歳ですか。私は３５歳です。私は何歳ですか。３５歳です。
    
    私は日本人です。私はアメリカ人ですか。違います。アメリカ人ではありません。アメリカ人ではなくて日本人です。私は中国人ですか。日本人ですか。日本人です。私はどこの国の人ですか。日本人です。私は日本人です。
    
    私は日本の福岡に住んでいます。私は東京に住んでいますか。いいえ、東京には住んでいません。東京ではなくて福岡に住んでいます。私は大阪に住んでいますか。福岡に住んでいますか。福岡に住んでいます。私はどこに住んでいますか。福岡に住んでいます。私は日本の福岡に住んでいます。
    
    私は日本語の先生です。私は看護師ですか。違います。看護師ではありません。看護師ではなくて日本語の先生です。私はプログラマーですか。日本語の先生ですか。日本語の先生です。私の仕事は何ですか。日本語の先生です。私は日本語の先生です。
    
    私は日本語の動画を作っています。日本語の歌を作っていますか。いいえ、日本語の歌は作っていません。日本語の歌ではなくて動画を作っています。日本語の本を作っていますか。日本語の動画を作っていますか。日本語の動画を作っています。私は何をしていますか。日本語の動画を作っています。
    
    もう１度自己紹介をします。私の名前はゆきです。３５歳です。日本人です。日本の福岡に住んでいます。日本語の先生です。日本語の動画を作っています。
    
    皆さんに質問です。皆さんに質問です。お名前は何ですか。何歳ですか。どこの国の方ですか。どこに住んでいますか。お仕事は何ですか。
    
    今日は私の自己紹介をしました。今日はこれでおしまい。またね！`,
    transcript_furigana: `こんにちは。今日きょうは私わたしの自己紹介じこしょうかいをします。私わたしの自己紹介じこしょうかいをします。

    私わたしの名前なまえはゆきです。３５歳さんじゅうごさいです。日本人にほんじんです。日本にほんの福岡ふくおかに住すんでいます。日本語にほんごの先生せんせいです。日本語にほんごの動画どうがを作つくっています。
    
    私わたしの名前なまえはゆきです。
    
    私わたしの名前なまえはドラどらえもんですか。違ちがいます。私わたしの名前なまえはドラどらえもんではありません。ドラどらえもんではなくてゆきです。
    
    私わたしの名前なまえはキティーきてぃーですか。ゆきですか。私わたしの名前なまえはゆきです。
    
    私わたしの名前なまえは何なんですか。ゆきです。私わたしの名前なまえはゆきです。
    
    私わたしは３５歳さんじゅうごさいです。
    
    私わたしは２５歳にじゅうごさいですか。いいえ、２５歳にじゅうごさいではありません。２５歳にじゅうごさいではなくて３５歳さんじゅうごさいです。
    
    私わたしは４５歳よんじゅうごさいですか。３５歳さんじゅうごさいですか。私わたしは３５歳さんじゅうごさいです。
    
    私わたしは何歳なんさいですか。３５歳さんじゅうごさいです。
    
    私わたしは日本人にほんじんです。
    
    私わたしはアメリカ人あめりかじんですか。違ちがいます。アメリカ人あめりかじんではありません。アメリカ人あめりかじんではなくて日本人にほんじんです。
    
    私わたしは中国人ちゅうごくじんですか。日本人にほんじんですか。日本人にほんじんです。
    
    私わたしはどこの国くにの人ひとですか。日本人にほんじんです。私わたしは日本人にほんじんです。
    
    私わたしは日本にほんの福岡ふくおかに住すんでいます。
    
    私わたしは東京とうきょうに住すんでいますか。いいえ、東京とうきょうには住すんでいません。東京とうきょうではなくて福岡ふくおかに住すんでいます。
    
    私わたしは大阪おおさかに住すんでいますか。福岡ふくおかに住すんでいますか。
    
    私わたしはどこに住すんでいますか。福岡ふくおかに住すんでいます。私わたしは日本にほんの福岡ふくおかに住すんでいます。
    
    私わたしは日本語にほんごの先生せんせいです。
    
    私わたしは看護師かんごしですか。違ちがいます。看護師かんごしではありません。看護師かんごしではなくて日本語にほんごの先生せんせいです。
    
    私わたしはプログラマーぷろぐらまーですか。日本語にほんごの先生せんせいですか。日本語にほんごの先生せんせいです。
    
    私わたしの仕事しごとは何なんですか。日本語にほんごの先生せんせいです。私わたしは日本語にほんごの先生せんせいです。
    
    私わたしは日本語にほんごの動画どうがを作つくっています。
    
    日本語にほんごの歌うたを作つくっていますか。いいえ、日本語にほんごの歌うたは作つくっていません。日本語にほんごの歌うたではなくて日本語にほんごの動画どうがを作つくっています。
    
    日本語にほんごの本ほんを作つくっていますか。日本語にほんごの動画どうがを作つくっていますか。日本語にほんごの動画どうがを作つくっています。
    
    私わたしは何なにをしていますか。日本語にほんごの動画どうがを作つくっています。
    
    もう１度いちど自己紹介じこしょうかいをします。
    
    私わたしの名前なまえはゆきです。３５歳さんじゅうごさいです。日本人にほんじんです。福岡ふくおかに住すんでいます。日本語にほんごの先生せんせいです。日本語にほんごの動画どうがを作つくっています。
    
    皆みなさんに質問しつもんです。皆みなさんに質問しつもんです。
    
    お名前なまえは何なんですか。何歳なんさいですか。どこの国くにの方かたですか。どこに住すんでいますか。お仕事しごとは何なんですか。
    
    今日きょうは私わたしの自己紹介じこしょうかいをしました。
    
    今日きょうはこれでおしまい。またね！`
},
{
  title: `日本のハロウィン Halloween in Japan`,
  url: `https://cijapanese.com/helloween-in-japan/`,
  level: `intermediate`,
  membership: `free`,
  transcript: `もうすぐハロウィンですね。今日が１０月２９日なので、もう明後日ですね。２日後です。ウィキペディアによると、元々はケルト人のお祭りだそうですね。で、それがイギリスやアメリカなど主に英語圏、英語を話す国に広まったと書いてありました。

  皆さんの国にはハロウィンを祝う習慣はありますか。元々日本には当然ハロウィンはありませんでした。私も子供の頃はハロウィンなんて知りませんでした。多分聞いたこともありませんでした。
  
  でもここ１０年くらいかな…急にハロウィンが日本で広まりました。一般的に知られるようになりました。今では日本の人もみんなハロウィンを知っています。特に若い人たちの間では仮装して街を歩いたり、友達と集まってパーティーしたりする文化が広まっています。
  ...
  transcript_furigana: `もうすぐハロウィンですね。

  今日きょうが１０月じゅうがつ２９日にじゅうくにちなので、もう明後日あさってですね。２日後ふつかごです。
  
  ウィキペディアによると、元々もともとはケルト人じんのお祭まつりだそうですね。
  
  で、それがイギリスやアメリカなど主おもに英語圏えいごけん、英語えいごを話はなす国くにに広ひろまったと書かいてありました。
  
  皆みなさんの国くににはハロウィンを祝いわう習慣しゅうかんはありますか。
  
  元々もともと日本にほんには当然とうぜんハロウィンはありませんでした。
  
  私わたしも子供こどもの頃ころはハロウィンなんて知しりませんでした。多分たぶん聞きいたこともありませんでした。
  
  でもここ１０年じゅうねんくらいかな…急きゅうにハロウィンが日本にほんで広ひろまりました。
  
  一般的いっぱんてきに知しられるようになりました。
  
  今いまでは日本にほんの人ひともみんなハロウィンを知しっています。
  
  特とくに若わかい人ひとたちの間あいだでは仮装かそうして街まちを歩あるいたり、友達ともだちと集あつまってパーティーしたりする文化ぶんかが広ひろまっています。
  
  元々もともとハロウィンはさっきも言いったようにケルト人じんのお祭まつりで、宗教的しゅうきょうてきな意味いみがある行事ぎょうじですよね。
  
  でも、日本にほんでは全まったく宗教的しゅうきょうてきな意味いみはありません。
  
  日本にほんの人ひとたちは単たんにイベントとしてハロウィンを楽たのしんでいます。
  
  ハロウィンだけじゃなくてクリスマスとかバレンタインも同おなじですね。
  
  日本人にほんじんは海外かいがいの文化ぶんか、特とくにイギリスやアメリカやオーストラリアなどの英語圏えいごけんの文化ぶんかやキリスト教圏きょうけんの文化ぶんかを取とり入いれて、日本風にほんふうにアレンジして楽たのしんでいます。
  
  皆みなさんはハロウィンの日ひに何なにをしますか。
  
  例たとえばこんな風ふうに家いえに飾かざり付つけをしたりしますか。
  
  日本にほんではこれはしません。
  
  飾かざり付つけをしている家いえは見みかけません。
  
  家いえをこんな風ふうに飾かざり付つけすることはないですけど、ハロウィンの時期じきになるとハロウィンの飾かざり付つけをしたレストランとかお店みせはよく見みかけます。
  
  それからお店みせに行いくとハロウィンの商品しょうひんもたくさん見みかけます。
  
  例たとえばパッケージにハロウィンの絵えが描かかれたお菓子かしなどがたくさん売うられています。
  
  じゃあ皆みなさんトリックオアトリートはしますか。
  
  子こどもたちが仮装かそうして近所きんじょの家いえを回まわってお菓子かしをもらうトリックオアトリート。
  
  これは皆みなさん子供こどもの頃ころしていましたか。
  
  これは日本にほんではあんまり一般的いっぱんてきではないです。
  
  私わたしは当然とうぜん子供こどもの頃ころしていなかったし、私わたしの子こどもたちもしたことはありません。
  
  でも、ハロウィンに子供こどもたちがお菓子かしをもらえるっていうのは日本にほんでも広ひろまっています。
  
  例たとえばショッピングモールや商店街しょうてんがい、あとは幼稚園ようちえんとか子供向こどもむけの英語教室えいごきょうしつとかでハロウィンのイベントがあって、子こどもたちがお菓子かしをもらえるということはよくあります。
  
  ハロウィンの時期じきになると色いろんな場所ばしょでお菓子かしがもらえるので、うちの息子むすこはハロウィンはお菓子かしがもらえる日ひって思おもっています。
  
  でも、さっきも言いったように、こんな風ふうに近所きんじょの家いえに行いって、トントンってしてトリックオアトリートをするっていう習慣しゅうかんは日本にほんにはありません。
  
  皆みなさんの国くにでは大人おとなの人ひとたちは何なにかしますか。
  
  皆みなさんは仮装かそうしますか。仮装かそうしてパーティーをしたりしますか。
  
  日本にほんでは仮装かそうして街まちを歩あるいたり、パーティーしたりする大人おとな、特とくに若わかい人ひとたちが多おおいです。
  
  私わたしはしたことないですけど。
  
  一番いちばん有名ゆうめいなのは、東京とうきょうの渋谷しぶやのハロウィンです。
  
  これは数年前すうねんまえのハロウィンのときの渋谷しぶやの写真しゃしんなんですけど、見みてください。すごい人ひとですよね。
  
  毎年まいとしものすごい人数にんずうの若者わかものが仮装かそうをして渋谷しぶやに集あつまるらしいです。
  
  日本にほんでは、特とくに若者わかものの間あいだでは、ハロウィンはなんかコスプレイベントみたいな感かんじになっているのかなぁと思おもいます。
  
  去年きょねんはコロナ禍かで例年れいねんほどではなかったみたいです。
  
  例年れいねんと比くらべると少すくなかったみたいですけど、それでも、沢山たくさんの人ひとが渋谷しぶやに集あつまったらしいです。
  
  今年ことしはどうなるんでしょう。
  
  今日きょうは日本にほんのハロウィンについてお話はなししました。
  
  今日きょうはこれでおしまい。またね！`
},
{
  title: `寿司の種類 Types of Sushi`,
  url: `https://cijapanese.com/types-of-sushi/`,
  level: `beginner`,
  membership: `free`,
  transcript: `これは何ですか。これは寿司ですね。皆さん寿司は好きですか。寿司をよく食べますか。時々食べますか。たまに食べますか。それとも全く食べませんか。

  寿司は、ご飯の上に魚を載せた食べ物ですね。このご飯は甘いですか。辛いですか。寿司のご飯は甘くありません。辛くもありません。ちょっと酸っぱいです。このご飯には酢が入っています。なので少し酸っぱいご飯です。酢飯といいます。
  
  酢飯の上に魚を載せます。この魚は焼いた魚ですか。煮た魚ですか。焼いた魚ではありません。煮た魚でもありません。生の魚です。
  
  魚と酢飯の間にわさびが入っています。わさびは辛いですね。皆さんわさびは好きですか。私はちょっと苦手です。私は好きじゃありません。なのでいつもサビ抜きを注文します。わさびを抜いてもらいます。サビ抜きのお寿司を頼みます。わさびが入っていないお寿司を頼みます。
  
  寿司にも色々な種類があるんですよ。今日は色々な寿司の種類を紹介します。
  
  これは握り寿司といいます。酢飯に魚を載せて、こうやってギュッギュッギュッと握ります。握って作るので握り寿司といいます。
  
  この写真、手前の１，２，３，４、４つは握り寿司ですね。奥の１，２，３、３つは軍艦巻きといいます。寿司の周りに海苔が巻いてありますね。軍艦巻きです。軍艦って何でしょう。軍艦とは、こんな船のことです。アメリカ軍とかイギリス軍など、軍の船のことを軍艦といいます。軍艦巻きは軍艦に形が似ているので、軍艦巻きと呼ばれているそうです。
  
  これはちらし寿司といいます。酢飯の上に色々な具をパラパラパラと散らします。具を散らすのでちらし寿司と呼ばれています。
  
  これは押し寿司といいます。押し寿司は、酢飯と魚を入れ物に入れてギューギューっと押して作ります。ギューっと押して作るので押し寿司と呼ばれています。
  
  これは巻き寿司です。海苔の上に酢飯を載せて、その上に具を載せて、クルクルクルっと巻きます。巻いて作るので巻き寿司と呼ばれています。
  
  これは手巻き寿司です。さっきの巻き寿司の仲間です。似ています。この巻き寿司は巻き簾を使って巻きます。でも手巻き寿司は、手で巻いて食べます。なので手巻き寿司といいます。
  
  今日は色んな種類の寿司を紹介しました。皆さんはどんな寿司を食べたことがありますか。どんな寿司が好きですか。
  
  今日はこれでおしまい。またね！`,
  transcript_furigana: `これは何なんですか。これは寿司すしですね。
  ...
  寿司すしは、ご飯はんの上うえに魚さかなを載のせた食たべ物ものですね。
  
  このご飯はんは甘あまいですか。辛からいですか。
  
  寿司すしのご飯はんは甘あまくありません。辛からくもありません。
  ...
  酢飯すめしの上うえに魚さかなを載のせます。
  
  この魚さかなは焼やいた魚さかなですか。煮にた魚さかなですか。
  
  焼やいた魚さかなではありません。煮にた魚さかなでもありません。
  
  生なまの魚さかなです。
  
  魚さかなと酢飯すめしの間あいだにわさびが入はいっています。
  
  わさびは辛からいですね。
  
  皆みなさんわさびは好すきですか。
  
  私わたしはちょっと苦手にがてです。わさびは好すきじゃありません。
  
  なのでいつもサビ抜さびぬきを注文ちゅうもんします。
  
  わさびを抜ぬいてもらいます。
  
  サビ抜さびぬきのお寿司すしを頼たのみます。
  
  わさびが入はいっていないお寿司すしを頼たのみます。
  
  寿司すしにも色々いろいろな種類しゅるいがあるんですよ。
  
  今日きょうは色々いろいろな寿司すしの種類しゅるいを紹介しょうかいします。
  
  これは握にぎり寿司ずしといいます。
  
  酢飯すめしに魚さかなを載のせて、こうやってギュッギュッギュッぎゅっぎゅっぎゅっと握にぎります。
  
  握にぎって作つくるので握にぎり寿司ずしといいます。
  
  この写真しゃしん、手前てまえの１いち，２に，３さん，４し、４よっつは握にぎり寿司ずしですね。
  
  奥おくの１いち，２に，３さん、３みっつは軍艦巻ぐんかんまきといいます。
  
  寿司すしの周まわりに海苔のりが巻まいてありますね。
  
  軍艦巻ぐんかんまきです。
  
  軍艦ぐんかんって何なんでしょう。軍艦ぐんかんとは、こんな船ふねのことです。
  
  アメリカ軍あめりかぐんとかイギリス軍いぎりすぐんなど、軍ぐんの船ふねのことを軍艦ぐんかんといいます。
  
  軍艦巻ぐんかんまきは軍艦ぐんかんに形かたちが似にているので、軍艦巻ぐんかんまきと呼よばれているそうです。
  
  これはちらし寿司ずしといいます。
  
  酢飯すめしの上うえに色々いろいろな具ぐをパラパラパラぱらぱらぱらと散ちらします。
  
  具ぐを散ちらすのでちらし寿司ずしと呼よばれています。
  
  これは押おし寿司ずしといいます。
  
  押おし寿司ずしは、酢飯すめしと魚さかなを入いれ物ものに入いれてギューギューぎゅーぎゅーっと押おして作つくります。
  
  ギューぎゅーっと押おして作つくるので押おし寿司ずしと呼よばれています。
  
  これは巻まき寿司ずしです。
  
  海苔のりの上うえに酢飯すめしを載のせて、その上うえに具ぐを載のせて、クルクルクルくるくるくるっと巻まきます。
  
  巻まいて作つくるので巻まき寿司ずしと呼よばれています。
  
  これは手巻てまき寿司ずしです。
  
  さっきの巻まき寿司ずしの仲間なかまです。似にています。
  
  この巻まき寿司ずしは巻まき簾すを使つかって巻まきます。
  
  でも手巻てまき寿司ずしは、手てで巻まいて食たべます。
  
  なので手巻てまき寿司ずしといいます。
  
  今日きょうは色いろんな種類しゅるいの寿司すしを紹介しょうかいしました。
  
  皆みなさんはどんな寿司すしを食たべたことがありますか。
...
{
  title: `何を使って食べる？ What do you use to eat it?`,
  url: `https://cijapanese.com/what-do-you-use-to-eat-it/`,
  level: `complete beginner`,
  membership: `free`,
  transcript: `これは箸です。これは箸です。これは何ですか。これはスプーンですね。これはスプーンです。これはフォークです。これはフォークです。これはナイフです。これはナイフです。

  箸があります。スプーンがあります。フォークがあります。ナイフがあります。箸とスプーンとフォークとナイフがあります。
  
  これを使って何をしますか。ドラムを叩きますか。違いますね。絵を描きますか。違いますね。箸とスプーンとフォークとナイフで食べます。これは食べるときに使います。ドラムを叩くときには使いません。絵を描くときにも使いません。食べるときに使います。
  
  これはうどんです。これはうどんです。うどんは好きですか。私は好きです。うどんを食べます。どれを使いますか。どれで食べますか。スプーンで食べますか。それとも箸で食べますか。箸で食べます。うどんは箸を使って食べます。うどんを食べるときには箸を使います。
  
  これはケーキです。いちごのケーキです。美味しそうですね。ケーキを食べます。何を使いますか。どれで食べますか。ケーキは箸で食べますか。それともフォークで食べますか。ケーキはフォークで食べます。フォークを使って食べます。ケーキを食べるときにはフォークを使います。
  
  これは何ですか。これはステーキです。ステーキは好きですか。私は好きです。ステーキを食べます。何を使って食べますか。ナイフと箸で食べますか。ナイフと箸でステーキを食べますか。それともフォークとスプーンで食べますか。それともナイフとフォークを使って食べますか。ステーキはナイフとフォークで食べます。ステーキを食べるときにはナイフとフォークを使います。
  
  これはスープです。スープを飲みます。スープは何を使って飲みますか。スープを飲むときにはどれを使いますか。箸を使いますか。箸で飲みますか。箸では飲めません。箸ではスープは飲めません。ナイフで飲めますか。ナイフでも飲めませんね。スープはスプーンを使って飲みます。スープを飲むときにはスプーンを使います。
  
  これはハンバーガーです。ハンバーガーを食べるときには何を使いますか。何か使いますか。何も使いませんね。ハンバーガーを食べるときにはナイフもフォークもスプーンも箸も使いません。手で食べます。
  
  皆さんはいつも食べるとき、何を使いますか。今日は食べるときに使うものの話をしました。今日はこれでおしまい。またね！`,
  transcript_furigana: `これは　箸はしです。
  ...
  箸はしと　スプーンすぷーんと　フォークふぉーくと　ナイフないふが　あります。
  ...
  箸はしと　スプーンすぷーんと　フォークふぉーくと　ナイフないふで　食たべます。
  
  これは　食たべるときに　使つかいます。
  
  ドラムどらむを　叩たたくときには　使つかいません。
  ...
  うどんは　箸はしを　使つかって　食たべます。
  
  うどんを　食たべるときには　箸はしを　使つかいます。
  ...
  それとも　フォークふぉーくで　食たべますか。
  
  ケーキけーきは　フォークふぉーくで　食たべます。
  
  フォークふぉーくを　使つかって　食たべます。
  
  ケーキけーきを　食たべるときには　フォークふぉーくを　使つかいます。
  ...
  ナイフないふと　箸はしで　ステーキすてーきを　食たべますか。
  
  それとも　フォークふぉーくと　スプーンすぷーんで　食たべますか。
  
  それとも　ナイフないふと　フォークふぉーくを　使つかって　食たべますか。
  
  ステーキすてーきは　ナイフないふと　フォークふぉーくで　食たべます。
  ...
  スープすーぷは　何なにを　使つかって　飲のみますか。
  
  スープすーぷを　飲のむときには　どれを　使つかいますか。
  ...
  箸はしでは　スープすーぷは　飲のめません。
  
  ナイフないふで　飲のめますか。
  
  ナイフないふでも　飲のめませんね。
  
  スープすーぷは　スプーンすぷーんを　使つかって　飲のみます。
  
  スープすーぷを　飲のむときには　スプーンすぷーんを　使つかいます。
  
  これは　ハンバーガーはんばーがーです。
  
  ハンバーガーはんばーがーを　食たべるときには　何なにを　使つかいますか。
  
  何なにか　使つかいますか。
  
  何なにも　使つかいませんね。
  
  ハンバーガーはんばーがーを　食たべるときには　ナイフないふも　フォークふぉーくも　スプーンすぷーんも　箸はしも　使つかいません。
  
  手てで　食たべます。
  
  皆みなさんは　いつも　食たべるとき、　何なにを　使つかいますか。
  
  今日きょうは　食たべるときに　使つかうものの　話はなしを　しました。
...
{
  title: `ドラえもんのひみつ道具 Doraemon’s Gadgets`,
  url: `https://cijapanese.com/doraemon-gadgets/`,
  level: `intermediate`,
  membership: `free`,
  transcript: `このキャラクター、知っていますか。これはドラえもんですね。ドラえもんのアニメを観たことはありますか。今日はドラえもんが持っているひみつ道具の話をします。

  ドラえもんのお腹にはポケットがあります。ここにポケットがありますね。実はこのポケット中には色々な道具が入ってるんです。皆さん何か知っているひみつ道具はありますか。今日はドラえもんのひみつ道具のうち、有名なものを４つ紹介します。
  
  まず一つ目はタケコプターです。タケコプターを頭につけると空を飛ぶことができます。タケコプターという名前の由来は何だと思いますか。
  
  タケコプターのタケは竹とんぼのタケです。竹とんぼって聞いたことありますか。何か知っていますか。竹とんぼとはこんな日本の昔のおもちゃです。こんな風に飛ばして遊ぶ昔のおもちゃです。この植物の名前は竹といいます。竹でできていて、形がトンボに似ているので「竹とんぼ」といいます。竹とんぼとタケコプター、形が似ていますよね。
  
  タケコプターのコプターは何だと思いますか。タケコプターのコプターはヘリコプターのコプターです。タケコプターはヘリコプターのプロペラのようにここが回ります。竹とんぼとヘリコプターでタケコプターになりました。
  
  これを頭につけると、この部分がヘリコプターのプロペラのようにクルクル回転して空を飛ぶことができます。こんな道具があったら良いですね。
  
  次、２つ目です。２つ目はどこでもドアです。どこでもドアはどこでも行きたい場所に行けるドアです。このドアを開けると一瞬で行きたい場所に行くことができます。皆さんだったらどこに行きたいですか。もしどこでもドアがあったらどこに行きたいですか。
  
  うちの息子は毎朝大体１５分〜２０分くらいかな？１人で歩いて学校に通ってるんですけど、時々朝学校に行く前に「どこでもドアがあったらいいのになぁ」「どこでもドアで学校に行けたら良いのになぁ」と言っています。皆さんがもしどこでもドアを持っていたらどこに行きますか。
  
  ３つ目、これは何ですかね。これは何かわかりますか。絵が下手ですね。これはタイムマシンです。ドラえもんはこんな小さいポケットの中からタイムマシンまで出せるんですよ。すごいですね。
  
  今２０２１年ですね。ドラえもんのタイムマシンに乗って過去に行ったり未来に行ったりすることができます。皆さんだったら過去と未来どっちに行きたいですか。過去に行くとしたら何年前に行きたいですか。何時代に行きたいですか。未来に行くとしたら何年後に行きたいですか。何年先の未来に行きたいですか。
  
  私はもし未来に行くとしたら、ずーっと先の未来に行きたいですね。１０年後とか２０年後とか、近い未来に行くのは嫌です。近い未来に行くのはちょっと怖いです。例えば１０年後、２０３１年に行ったとして、もし自分とか家族が幸せじゃなかったら、不幸になってたら、ショックですね。もし、もしですよ、１０年後の未来に行って自分がいなかったりしたらすごいショックです。
  
  なのであんまり近い未来は見たくないです。もし未来に行くとしたら、ずーっと先の２００年後とか３００年後に行ってみたいです。どんな世界になってるのか見てみたいです。
  
  過去に行けるとしたら、どうですかね。私はあんまり歴史のこと、昔の時代のことには詳しくないので、昔の時代に行っても、例えば江戸時代とか鎌倉時代とかに行ってもあんまり楽しくないかもしれません。２０年ぐらい前の中学生か高校生ぐらいの自分に会いに行きたいかもしれません。
  
  学生時代の自分に会いに行って、色々アドバイスしてあげたいです。「勉強一生懸命頑張ったほうがいいよ！」とか「本をたくさん読んだほうがいいよ！」とかアドバイスしてあげたいですね。皆さんならどうですか。いつの時代に行ってみたいですか。
  
  最後にもう１つドラえもんのひみつ道具を紹介します。４つ目。これは皆さんが欲しがるかもしれません。あったらいいな…と思うかもしれません。アンキパンです。一見普通の食パンですよね。でも実は普通の食パンではないんです。
  
  ノートや本にこのパンをギューっと押し当てると、そのページに書いてある内容をパンに写すことができるそうです。そしてこのパンを食べると、そこに書いてあった内容が全部暗記できるんだそうです。良いですよね！もしこれがあったら、日本語を勉強している皆さん、漢字を覚えるのも簡単ですね！
  
  今日はドラえもんのひみつ道具を４つ紹介しました。皆さんが知っているひみつ道具はありましたか。この中でどれがあったら良いなと思いますか。これ以外にも何か知っているものはありますか。今日はこれでおしまい。またね！`,
  transcript_furigana: `このキャラクター、知しっていますか。これはドラえもんですね。

  ドラえもんのアニメを観みたことはありますか。
  
  今日きょうはドラえもんが持もっているひみつ道具どうぐの話はなしをします。
  
  ドラえもんのお腹なかにはポケットがあります。ここにポケットがありますね。
  
  実じつはこのポケット中なかには色々いろいろな道具どうぐが入はいってるんです。
  
  皆みなさん何なにか知しっているひみつ道具どうぐはありますか。
  
  今日きょうはドラえもんのひみつ道具どうぐのうち、有名ゆうめいなものを４よっつ紹介しょうかいします。
  
  まず１ひとつ目めはタケコプターです。
  
  タケコプターを頭あたまにつけると空そらを飛とぶことができます。
  
  タケコプターという名前なまえの由来ゆらいは何なんだと思おもいますか。
  
  タケコプターのタケは竹たけとんぼのタケです。
  
  竹たけとんぼって聞きいたことありますか。何なにか知しっていますか。
  
  竹たけとんぼとはこんな日本にほんの昔むかしのおもちゃです。
  
  こんな風ふうに飛とばして遊あそぶ昔むかしのおもちゃです。
  
  この植物しょくぶつの名前なまえは竹たけといいます。
  
  竹たけでできていて、形かたちがトンボに似にているので「竹たけとんぼ」といいます。
  
  竹たけとんぼとタケコプター、形かたちが似にていますよね。
  
  タケコプターのコプターは何なんだと思おもいますか。
  
  タケコプターのコプターは、ヘリコプターのコプターです。
  
  タケコプターはヘリコプターのプロペラのようにここが回まわります。
  
  竹たけとんぼとヘリコプターでタケコプターになりました。
  
  これを頭あたまにつけると、この部分ぶぶんがヘリコプターのプロペラのようにクルクル回転かいてんして空そらを飛とぶことができます。
  
  こんな道具どうぐがあったら良いいですね。
  
  次つぎ、２ふたつ目めです。２ふたつ目めはどこでもドアです。
  
  どこでもドアはどこでも行いきたい場所ばしょに行いけるドアです。
  
  このドアを開あけると一瞬いっしゅんで行いきたい場所ばしょに行いくことができます。
  
  皆みなさんだったらどこに行いきたいですか。もしどこでもドアがあったらどこに行いきたいですか。
  
  うちの息子むすこは毎朝まいあさ大体だいたい１５分じゅうごふん〜から２０分にじゅっぷんくらいかな？１人ひとりで歩あるいて学校がっこうに通かよってるんですけど、
  
  時々ときどき朝あさ学校がっこうに行いく前まえに「どこでもドアがあったらいいのになぁ」「どこでもドアで学校がっこうに行いけたら良いいのになぁ」と言いっています。
  
  皆みなさんがもしどこでもドアを持もっていたらどこに行いきますか。
  
  ３みっつ目め、これは何なんですかね。これは何なにかわかりますか。
  
  絵えが下手へたですね。これはタイムマシンです。
  
  ドラえもんはこんな小ちいさいポケットの中なかからタイムマシンまで出だせるんですよ。すごいですね。
  
  今いま２０２１年にせんにじゅういちねんですね。
  
  ドラえもんのタイムマシンに乗のって過去かこに行いったり未来みらいに行いったりすることができます。
  
  皆みさんだったら過去かこと未来みらいどっちに行いきたいですか。
  
  過去かこに行いくとしたら何年前なんねんまえに行いきたいですか。何時代なにじだいに行いきたいですか。
  
  未来みらいに行いくとしたら何年後なんねんごに行いきたいですか。何年先なんねんさきの未来みらいに行いきたいですか。
  
  私わたしはもし未来みらいに行いくとしたら、ずーっと先さきの未来みらいに行いきたいですね。
  
  １０年後じゅうねんごとか２０年後にじゅうねんごとか、近ちかい未来みらいに行いくのは嫌いやです。
  
  近ちかい未来みらいに行いくのはちょっと怖こわいです。
  
  例たとえば１０年後じゅうねんご、２０３１年にせんさんじゅういちねんに行いったとして、もし自分じぶんとか家族かぞくが幸しあわせじゃなかったら、不幸ふこうになってたら、ショックですね。
  
  もし、もしですよ、１０年後じゅうねんごの未来みらいに行いって自分じぶんがいなかったりしたらすごいショックです。
  
  なのであんまり近ちかい未来みらいは見みたくないです。
  
  もし未来みらいに行いくとしたら、ずーっと先さきの２００年後にひゃくねんごとか３００年後さんびゃくねんごに行いってみたいです。
  
  どんな世界せかいになってるのか見みてみたいです。
  
  過去かこに行いけるとしたら、どうですかね。
  
  私わたしはあんまり歴史れきしのこと、昔むかしの時代じだいのことには詳くわしくないので、昔むかしの時代じだいに行いっても、例たとえば江戸時代えどじだいとか鎌倉時代かまくらじだいとかに行いってもあんまり楽たのしくないかもしれません。
  
  ２０年にじゅうねんぐらい前まえの中学生ちゅうがくせいか高校生こうこうせいぐらいの自分じぶんに会あいに行いきたいかもしれません。
  
  学生時代がくせいじだいの自分じぶんに会あいに行いって、色々いろいろアドバイスしてあげたいです。
  
  「勉強べんきょう一生懸命いっしょうけんめい頑張がんばったほうがいいよ！」とか「本ほんをたくさん読よんだほうがいいよ！」とかアドバイスしてあげたいですね。
  
  皆みなさんならどうですか。いつの時代じだいに行いってみたいですか。
  
  最後さいごにもう１ひとつドラえもんのひみつ道具どうぐを紹介しょうかいします。
  
  ４よっつ目め。これは皆みなさんが欲ほしがるかもしれません。
  
  あったらいいな…と思おもうかもしれません。
  
  アンキパンです。
  
  一見いっけん普通ふつうの食しょくパンですよね。でも実じつは普通ふつうの食しょくパンではないんです。
  
  ノートや本ほんにこのパンをギューっと押おし当あてると、そのページに書かいてある内容ないようをパンに写うつすことができるそうです。
  
  そしてこのパンを食たべると、そこに書かいてあった内容ないようが全部ぜんぶ暗記あんきできるんだそうです。
  
  良いいですよね！もしこれがあったら、日本語にほんごを勉強べんきょうしている皆みなさん、漢字かんじを覚おぼえるのも簡単かんたんですね！
  
  今日きょうはドラえもんのひみつ道具どうぐを４よっつ紹介しょうかいしました。
  
  皆みなさんが知しっているひみつ道具どうぐはありましたか。
  
  この中なかでどれがあったら良いいなと思おもいますか。
  
  これ以外いがいにも何なにか知しっているものはありますか。
  
  今日きょうはこれでおしまい。またね！`
},
{
  title: `サンタさん Santa Claus`,
  url: `https://cijapanese.com/santa-claus/`,
  level: `complete beginner`,
  membership: `free`,
  transcript: `これは誰ですか。これは誰ですか。サンタクロースです。サンタさんです。

  サンタさんは帽子を被っています。サンタさんは帽子を被っています。何色の帽子を被っていますか。サンタさんの帽子は何色ですか。青ですか。違いますね。紫ですか。違います。緑ですか。違います。サンタさんの帽子は何色ですか。サンタさんの帽子は赤です。赤です。サンタさんは赤い帽子を被っています。
  
  サンタさんはおじいさんです。おじいさんです。おばあさんではありません。お兄さんでもありません。お姉さんでもありません。サンタさんはおじいさんです。ひげがあります。これはひげです。サンタさんのひげは長いです。ひげは何色ですか。紫ですか。オレンジですか。黄色ですか。何色ですか。サンタさんのひげは白です。長くて白いひげです。
  
  これはカレンダーです。サンタさんはいつ来ますか。いつ来ますか。３月に来ますか。５月に来ますか。８月に来ますか。それとも１２月に来ますか。１２月に来ます。サンタさんは１２月に来ます。サンタさんはハロウィンに来ますか。それともクリスマスに来ますか。クリスマスに来ますね。
  
  クリスマスに何を持って来ますか。何を持って来ますか。これはゴミです。これはプレゼントです。サンタさんはクリスマスにゴミを持って来ますか。それともプレゼントを持って来ますか。サンタさんはプレゼントを持って来ます。ゴミは持って来ません。プレゼントを持って来ます。そしてプレゼントを配ります。誰にプレゼントを配りますか。子供に配りますか。それとも大人に配りますか。子供に配ります。サンタさんは大人ではなくて子供にプレゼントを配ります。
  
  朝です。昼です。夕方です。夜です。サンタさんはいつ来ますか。朝に来ますか。昼に来ますか。夕方に来ますか。それとも夜に来ますか。サンタさんは夜に来ます。夜、子供達は寝ています。サンタさんは夜、子供達が寝ている間に来ます。
  
  これは車です。これは電車です。これはバスです。サンタさんは何に乗って来ますか。車に乗って来ますか。電車に乗って来ますか。バスに乗って来ますか。何に乗って来ますか。これはソリです。サンタさんはソリに乗って来ます。車でも電車でもバスでもありません。ソリに乗って来ます。
  
  これは猫です。これは豚です。これは象です。動物です。何の動物がサンタさんのソリを引きますか。猫ですか。違いますね。豚ですか。違います。象ですか。違います。サンタさんのソリを引く動物は何ですか。トナカイです。トナカイがサンタさんのソリを引きます。
  
  サンタさんは赤い帽子を被って白くて長いひげを生やしたおじいさんです。クリスマスにトナカイが引くソリに乗って、プレゼントを持って来ます。夜、子供達が寝ている間にプレゼントを配ります。
  
  今日はサンタさんの話をしました。皆さん楽しいクリスマスを過ごしてください。今日はこれでおしまい。またね！`,
  transcript_furigana: `これは誰だれですか。これは誰だれですか。サンタクロースさんたくろーすです。サンタさんたさんです。

  サンタさんたさんは帽子ぼうしを被かぶっています。サンタさんたさんは帽子ぼうしを被かぶっています。
  
  何色なにいろの帽子ぼうしを被かぶっていますか。サンタさんたさんの帽子ぼうしは何色なにいろですか。
  ...
  サンタさんたさんの帽子ぼうしは何色なにいろですか。
  
  サンタさんたさんの帽子ぼうしは赤あかです。赤あかです。
  
  サンタさんたさんは赤あかい帽子ぼうしを被かぶっています。
  
  サンタさんたさんはおじいさんです。おじいさんです。
  ...
  ひげは何色なにいろですか。紫むらさきですか。オレンジおれんじですか。黄色きいろですか。何色なにいろですか。
  
  サンタさんたさんのひげは白しろです。長ながくて白しろいひげです。
  
  これはカレンダーかれんだーです。
  
  サンタさんたさんはいつ来きますか。いつ来きますか。
  
  ３月さんがつに来きますか。５月ごがつに来きますか。８月はちがつに来きますか。それとも１２月じゅうにがつに来きますか。
  
  １２月じゅうにがつに来きます。サンタさんたさんは１２月じゅうにがつに来きます。
  
  サンタさんたさんはハロウィンはろうぃんに来ますか。それともクリスマスくりすますに来きますか。
  
  クリスマスくりすますに来きますね。
  
  クリスマスくりすますに何なにを持もって来きますか。何なにを持もって来きますか。
  
  これはゴミごみです。これはプレゼントぷれぜんとです。
  
  サンタさんたさんはクリスマスくりすますにゴミごみを持もって来きますか。それともプレゼントぷれぜんとを持もって来きますか。
  
  サンタさんたさんはプレゼントぷれぜんとを持もって来きます。
  
  ゴミごみは持もって来きません。プレゼントぷれぜんとを持もって来きます。
  
  そしてプレゼントぷれぜんとを配くばります。
  
  誰だれにプレゼントぷれぜんとを配くばりますか。
  
  子供こどもに配くばりますか。それとも大人おとなに配くばりますか。
  
  子供こどもに配くばります。サンタさんたさんは大人おとなではなくて子供こどもにプレゼントぷれぜんとを配くばります。
  
  朝あさです。昼ひるです。夕方ゆうがたです。夜よるです。
  
  サンタさんたさんはいつ来きますか。
  
  朝あさに来きますか。昼ひるに来きますか。夕方ゆうがたに来きますか。それとも夜よるに来きますか。
  
  サンタさんたさんは夜よるに来きます。
  
  夜よる、子供達こどもたちは寝ねています。サンタさんたさんは夜よる、子供達こどもたちが寝ねている間あいだに来きます。
  
  これは車くるまです。これは電車でんしゃです。これはバスばすです。
  
  サンタさんたさんは何なにに乗のって来きますか。
  
  車くるまに乗のって来きますか。電車でんしゃに乗のって来きますか。バスばすに乗のって来きますか。
  
  何なにに乗のって来きますか。
  
  これはソリそりです。サンタさんたさんはソリそりに乗のって来きます。
  
  車くるまでも電車でんしゃでもバスばすでもありません。ソリそりに乗のって来きます。
  
  これは猫ねこです。これは豚ぶたです。これは象ぞうです。動物どうぶつです。
  
  何なんの動物どうぶつがサンタさんたさんのソリそりを引ひきますか。
  ...
  サンタさんたさんのソリそりを引ひく動物どうぶつは何なんですか。
  
  トナカイとなかいです。トナカイとなかいがサンタさんたさんのソリそりを引ひきます。
  
  サンタさんたさんは赤あかい帽子ぼうしを被かぶって白しろくて長ながいひげを生はやしたおじいさんです。
  
  クリスマスくりすますにトナカイとなかいが引ひくソリそりに乗のって、プレゼントぷれぜんとを持もって来きます。
  
  夜よる、子供達こどもたちが寝ねている間あいだにプレゼントぷれぜんとを配くばります。
  
  今日きょうはサンタさんたさんの話はなしをしました。
  
  皆みなさん楽たのしいクリスマスくりすますを過すごしてください。
  
  今日きょうはこれでおしまい。またね！`
},
{
  title: `かさじぞう（日本の昔話） Kasa Jizo (Japanese Folktale)`,
  url: `https://cijapanese.com/kasa-jizo/`,
  level: `intermediate`,
  membership: `free`,
  transcript: `今日は「かさじぞう」という日本の昔話をします。
  ...
  １２月３１日。大晦日の夜の出来事です。あるところに、おじいさんおばあさんが住んでいました。おじいさんとおばあさんにはお金がありません。貧しい暮らしをしています。日本ではお正月に餅を食べますが、明日からお正月なのに、おじいさんとおばあさんは貧しくて、餅すら買えません。
  
  おじいさんは、町へ笠を売りに行くことにしました。おばあさんが作った手作りの笠です。笠を売ってお金を稼いで、町でお正月に食べる食べ物を買おうと思いました。「行ってきます！」「行ってらっしゃい！気をつけてね。」おばあさんがおじいさんを見送ります。
  
  外は雪が降っています。大雪です。とても寒いです。町へ行く途中にお地蔵さんがありました。お地蔵さんが６体並んでいます。おじいさんは「お地蔵さんも寒そうだなぁ」と思いました。お地蔵さんの頭には雪が積もっています。おじいさんはそれを手で払い落としてあげました。
  ...
  でも笠は５つしかありませんでした。１つ足りません。おじいさんは自分が被っていた笠をとって、お地蔵さんに被せてあげました。そして大雪の中、自分は笠なしで、笠を被らずに家に帰りました。
  ...
  「何これ！？」二人はびっくりしています。ふと前を見ると、笠を被った６体のお地蔵さんが去っていくのが見えました。お地蔵さんが持ってきてくれた食べ物のお陰で、二人は良いお正月を迎えることができました。
  
  今日は「かさじぞう」のお話をしました。今日はこれでおしまい。またね！`,
  transcript_furigana: `今日きょうは「かさじぞう」という日本にほんの昔話むかしばなしをします。

  「かさじぞう」の笠かさとはこんな被かぶり物もののことです。帽子ぼうしみたいですよね。
  
  今いまの時代じだい、笠かさを被かぶっている人ひとは滅多めったにいませんが昔むかしの人ひとは、雨あめや雪ゆきや日差ひざしから頭あたまを守まもるために笠かさを被かぶっていたそうです。
  
  「かさじぞう」の地蔵じぞうとは、こんな石いしでできた石像せきぞうのことです。
  
  お地蔵じぞうさんと言いったり、お地蔵様じぞうさまと言いったりします。
  
  お寺てらや道端みちばたで見みかけることがありますよ。
  
  仏教ぶっきょうではお地蔵じぞうさんが私達わたしたちのことを守まもってくれると信しんじられています。
  
  また、悲かなしいことや辛つらいことがあったとき、お地蔵じぞうさんが代かわりに苦くるしみを引ひき受うけてくれる、身代みがわりになってくれると信しんじられています。
  
  なのでお地蔵じぞうさんを見みかけたら、手てを合あわせてお辞儀じぎをしたり、お供そなえ物ものをしたりします。
  
  それでは「かさじぞう」の話はなしを始はじめます。
  
  １２月じゅうにがつ３１日さんじゅういちにち。大晦日おおみそかの夜よるの出来事できごとです。
  
  あるところに、おじいさんおばあさんが住すんでいました。
  
  おじいさんとおばあさんにはお金かねがありません。貧まずしい暮くらしをしています。
  
  日本にほんではお正月しょうがつに餅もちを食たべますが、明日あしたからお正月しょうがつなのに、おじいさんとおばあさんは貧まずしくて、餅もちすら買かえません。
  
  おじいさんは、町まちへ笠かさを売うりに行いくことにしました。
  
  おばあさんが作つくった手作てづくりの笠かさです。
  
  笠かさを売うってお金かねを稼かせいで、町まちでお正月しょうがつに食たべる食たべ物ものを買かおうと思おもいました。
  
  「行いってきます！」「行いってらっしゃい！気きをつけてね。」おばあさんがおじいさんを見送みおくります。
  
  外そとは雪ゆきが降ふっています。大雪おおゆきです。とても寒さむいです。
  
  町まちへ行いく途中とちゅうにお地蔵じぞうさんがありました。お地蔵じぞうさんが６体ろくたい並ならんでいます。
  
  おじいさんは「お地蔵じぞうさんも寒さむそうだなぁ」と思おもいました。
  
  お地蔵じぞうさんの頭あたまには雪ゆきが積つもっています。おじいさんはそれを手てで払はらい落おとしてあげました。
  
  おじいさんはお地蔵じぞうさんに何なにかお供そなえしたいです。
  
  ですが、おじいさんは何なにも持もっていません。お地蔵じぞうさんにお供そなえできるものが何なにもありません。
  
  おじいさんは申もうしし訳わけないなと思おもいました。何なにもお供そなえできなくてごめんなさいと思おもいながら、お地蔵じぞうさんにお辞儀じぎをしてまた町まちへ向むかって歩あるいていきました。
  
  「笠かさはいりませんか。」「笠かさはいりませんか。」おじいさんは笠かさを売うろうと町中まちじゅうを歩あるき回まわりますが、笠かさは全まったく売うれません。誰だれも買かってくれません。
  
  笠かさはたくさん売うれ残のこってしまいました。
  
  「仕方しかたない。もう家いえに帰かえろう。」おじいさんは笠かさを売うるのを諦あきらめて家いえに帰かえることにしました。
  
  帰かえり道みち、またお地蔵じぞうさんの前まえを通とおりました。
  
  お地蔵じぞうさんの頭あたまにはまた雪ゆきが積つもっています。おじいさんは、お地蔵じぞうさんの頭あたまの雪ゆきを払はらい落おとしました。
  
  「お地蔵じぞうさん、寒さむいでしょう。」と言いって、売うれ残のこった笠かさをお地蔵じぞうさんに被かぶせてあげました。
  
  でも笠かさは５いつつしかありませんでした。１ひとつ足たりません。
  
  おじいさんは自分じぶんが被かぶっていた笠かさをとって、お地蔵じぞうさんに被かぶせてあげました。
  
  そして大雪おおゆきの中なか、自分じぶんは笠かさなしで、笠かさを被かぶらずに家いえに帰かえりました。
  
  「ただいま」「お帰かえりなさい」
  
  おじいさんは雪ゆきまみれです。とっても寒さむそうです。
  
  雪ゆきまみれになったおじいさんを見みたおばあさんは、驚おどろいて「どうしたの？」と聞ききました。
  
  おじいさんは、笠かさが売うれなかったこと、それから、売うれ残のこった笠かさをお地蔵じぞうさんに被かぶせてあげたことをおばあさんに話はなしました。
  
  おばあさんはにこにこ笑わらって「良いいことをしたね。」と言いいました。
  
  笠かさが売うれず、正月しょうがつに食たべる食たべ物ものは買かえませんでした。
  
  でもおばあさんは怒おこったりしませんでした。おじいさんを責せめたりしませんでした。
  
  その夜よる、二人ふたりが眠ねむってしばらく経たった頃ころ、外そとから何なにか音おとが聞きこえてきました。
  
  「何なんの音おとだろう？」二人ふたりが目めを覚さまして戸とを開あけると、家いえの前まえにはたくさんの食たべ物ものが置おかれていました。
  
  「何なにこれ！？」二人ふたりはびっくりしています。
  
  ふと前まえを見みると、笠かさを被かぶった６体ろくたいのお地蔵じぞうさんが去さっていくのが見みえました。
  
  お地蔵じぞうさんが持もってきてくれた食たべ物もののお陰かげで、二人ふたりは良いいお正月しょうがつを迎むかえることができました。
  
  今日きょうは「かさじぞう」のお話はなしをしました。
